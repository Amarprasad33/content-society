...
export default function HeroProfileCard() {
    return (
        <div className="relative p-[1px] scale-[0.8] md:scale-[1]">
            <div className="absolute rounded-3xl bg-[linear-gradient(to_bottom_right,_#D9D9D9_14%,_transparent_69%)] z-0 inset-0 w-full h-full" />
            <Card className="h-fit border-none z-10 bg-[#110d27] text-white rounded-3xl relative overflow-hidden">
                <CardContent className="py-8 px-8">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <Button
                            variant="ghost"
                            className="w-[200px] h-10 rounded-[58px] border border-[#A26EFC] hover:text-white bg-inherit hover:bg-[#19123e]"
                        >
