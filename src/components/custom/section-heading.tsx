...
export default function SectionHeading({ mainHeading, subHeading }: { mainHeading: string, subHeading: string }) {
  return (
    <div className="mt-10 mb flex flex-col gap-3 w-[100%] sm:w-[80%] lg:w-full">
      <div className="relative mx-auto w-fit max-w-[64%] text-center">
        ...
        <div className="text-2xl sm:text-4xl md:text-5xl font-semibold z-10 relative">{mainHeading}</div>
