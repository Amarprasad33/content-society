...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center w-full min-h-screen bg-[#0B051D]">
        ...
        <div className="relative w-full h-full max-w-[1920px] flex flex-col gap-5 border border-red-500">
          ...
          <div className="z-10 relative mt-[2rem] w-full border border-blue-800">
            ...
            <div className="absolute inset-0 border border-pink-500 w-full h-fit flex items-center justify-center">
              <div className="w-fit z-30 scale-75 sm:scale-100">
                <HeroProfileCard />
              </div>
              <div className="absolute z-10 h-[27rem] w-[30rem] border border-red-500">
                <div className="absolute -right-5 sm:-right-56 top-10 sm:top-[3.9rem] rotate-[8.6deg] sm:rotate-[17.6deg] scale-75 sm:scale-100">
                  <HeroProfileCard />
                </div>
                <div className="absolute -left-5 sm:-left-56 top-10 sm:top-[3.9rem] -rotate-[8.6deg] sm:-rotate-[17.6deg] scale-75 sm:scale-100">
                  <HeroProfileCard />
                </div>
              </div>
            </div>
        ...
        <div className="bento-container border border-rose-600 w-[80%] min-h-screen mt-8 flex flex-col items-center gap-6 pb-16">
          <div className="bento-row w-fit flex gap-6">
            ...
            <div className="relative w-[428px] sm:w-[640px] h-[420px] overflow-hidden rounded-2xl bg-[linear-gradient(to_top,_rgba(18,14,37,0.84)_14%,_rgba(53,35,144,0.69)_100%)]">
              ...
              <div className="p-[1px] rounded-lg z-1 bg-linear-to-r from-[#4E0AC2] to-[#25055C] w-fit bottom-[7rem] absolute left-[calc(100%-16rem)] sm:left-[calc(100%-23rem)]">
      ...
      <section className="flex flex-col items-center w-full border border-green-400 min-h-screen overflow-hidden">
        <SectionHeading
        ...
        />
        <div className="testimonials-container mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 border border-amber-200 w-[85%] lg:w-[75%] max-w-7xl">
